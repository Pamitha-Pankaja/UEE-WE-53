...
class _AddpropertiesState extends State<AddProperty> {
  ...
  List<String> watermethods = ["ඇළ මාර්ග", "ගංගා", "අහස්දිය", "භූගත ජලය", "වැව"];
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            buildDropdownField(
                selectedmainirrigationarea, mainirrigationarea, 'ප්‍රදාන වාරිමාර්ග කලාපය'),
            SizedBox(height: 16),
